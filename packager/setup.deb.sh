...
main ()
{
    ...
    gpg_key_url="https://packagecloud.io/$REPOSITORY_OWNER/ssp/gpgkey"
    apt_config_url="https://packagecloud.io/install/repositories/$REPOSITORY_OWNER/ssp/config_file.list?os=${os}&dist=${dist}&source=script"

    apt_source_path="/etc/apt/sources.list.d/"$REPOSITORY_OWNER"_ssp.list"
    ...
    apt-get install -y ssp &> /dev/null
    echo "done."

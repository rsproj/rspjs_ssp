...
module.exports = function ClusterMode(God) {
  ...
  God.nodeApp = function nodeApp(env_copy, cb){
    ...
    env_copy._ssp_version = pkg.version;
    ...
    try {
      ...
      clu = cluster.fork({ssp_env: JSON.stringify(env_copy), windowsHide: true});
    } catch(e) {
      God.logAndGenerateError(e);
      return cb(e);
    }

    clu.ssp_env = env_copy;
    ...
    clu.on('message', function cluMessage(msg) {
      ...
      if (msg.data && msg.type) {
        return God.bus.emit(msg.type ? msg.type : 'process:msg', {
          ...
          data    : msg.data,
          process :  {
            pm_id      : clu.ssp_env.pm_id,
            name       : clu.ssp_env.name,
            rev        : (clu.ssp_env.versioning && clu.ssp_env.versioning.revision) ? clu.ssp_env.versioning.revision : null,
            namespace  : clu.ssp_env.namespace
          }
        });
      }
      else {
        ...
        if (typeof msg == 'object' && 'node_version' in msg) {
          clu.ssp_env.node_version = msg.node_version;
          return false;
        }

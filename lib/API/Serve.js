...
var debug = require('debug')('ssp:serve');

var probe = require('@ssp/io');
...
}(window,document,'https://apm.ssp.io/ssp-io-apm-browser.v1.js','sspReady','script'))

sspReady(function(apm) {

...
var Utility = module.exports = {
  ...
  extendExtraConfig : function(proc, opts) {
    if (opts.env && opts.env.current_conf) {
      ...
      Utility.extendMix(proc.ssp_env, opts.env.current_conf);
  ...
  formatCLU : function(process) {
    ...
    var obj = Utility.clone(process.ssp_env);
    delete obj.env;
  ...
  startLogging : function(stds, callback) {
    ...
    (function createWS(io){
      ...
      // compatible with `ssp reloadLogs`
   ...
   * @example Always returns 'ssp-slack' for inputs 'ma-zal/ssp-slack', 'ma-zal/ssp-slack#own-branch',
   *          'ssp-slack-1.0.0.tgz' or 'ssp-slack@1.0.0'.
   */

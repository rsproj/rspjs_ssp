...
var API = module.exports = function(opts) {
  ...
  if (opts.ssp_home) {
    ...
    conf = util._extend(conf, path_structure(this.ssp_home));
  }
...
API.prototype.update = function(cb) {
  ...
  that.getVersion(function(err, new_version) {
    // If not linked to keymetrics, and update ssp to latest, display motd.update
 ...
 * @return
 */
API.prototype.describe = function(ssp_id, cb) {
  var that = this;
...
API.prototype.deepUpdate = function(cb) {
  ...
  var exec = require('shelljs').exec;
  var child = exec("npm i -g ssp@latest; ssp update", {async : true});
